...
.dark.sticky nav.main_menu > ul > li.active > a {
	hlline-height: <?php echo $qode_options_proya['header_height_sticky'];  ?>px;
}
...
nav.main_menu > ul > li > a{
	<?php //line-height: echo $qode_options_proya['header_height'];px; ?>
}
<?php } ?>
...
nav.main_menu > ul > li > a{
    ...
    <?php if (!empty($qode_options_proya['menu_lineheight'])) { ?> line-height: <?php echo $qode_options_proya['menu_lineheight'];  ?>; <?php } ?>
...
.drop_down .wide .second .inner ul li .flexslider ul li .menu_recent_post a{
	...
	<?php if ($qode_options_proya['dropdown_letterspacing_thirdlvl'] !== '') { ?> letter-spacing: <?php echo $qode_options_proya['dropdown_letterspacing_thirdlvl'];  ?>;  <?php } ?>
}
...
<?php if (!empty($qode_options_proya['input_background_color']) || !empty($qode_options_proya['input_border_color']) || !empty($qode_options_proya['input_text_color'])) { ?>
	...
	<?php if (!empty($qode_options_proya['input_text_color'])) { ?>background-color:<?php echo $qode_options_proya['input_text_color'];  ?>; <?php } ?>
	}
<?php } ?>
<?php if (!empty($qode_options_proya['smooth_background_color'])) { ?>
#ascrail2000{
	background-color: <?php echo $qode_options_proya['smooth_background_color'];  ?>;
}
<?php } ?>
<?php if (!empty($qode_options_proya['smooth_bar_color'])) {
?>
#ascrail2000 div{
	background-color: <?php echo $qode_options_proya['smooth_bar_color'];  ?> !important;
}
<?php } ?>
...
<?php } ?>
<?php if (!empty($qode_options_proya['testimonaials_navigation_border_radius'])) { ?>
	.testimonials_holder .flex-direction-nav a{
	<?php if (!empty($qode_options_proya['testimonaials_navigation_border_radius'])) { ?>	border-radius: <?php echo $qode_options_proya['testimonaials_navigation_border_radius'];  ?>px; <?php } ?>
	<?php if (!empty($qode_options_proya['testimonaials_navigation_border_radius'])) { ?>	-moz-border-radius: <?php echo $qode_options_proya['testimonaials_navigation_border_radius'];  ?>px; <?php } ?>
	<?php if (!empty($qode_options_proya['testimonaials_navigation_border_radius'])) { ?>	-webkit-border-radius: <?php echo $qode_options_proya['testimonaials_navigation_border_radius'];  ?>px; <?php } ?>
...
<?php } ?>
<?php if (!empty($qode_options_proya['vertical_menu_color']) || !empty($qode_options_proya['vertical_menu_fontsize']) || !empty($qode_options_proya['vertical_menu_fontstyle']) || !empty($qode_options_proya['vertical_menu_fontweight']) || !empty($qode_options_proya['vertical_menu_letter_spacing']) || $qode_options_proya['vertical_menu_google_fonts'] != "-1") { ?>
