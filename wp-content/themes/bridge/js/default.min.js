...
$j(window).scroll(function() {
	...
	$j('a[href$=".tumblr.com/"]').attr('target', '_blank');
});
		...
		if($scroll > sticky_amount){
			if(!$j('header.page_header').hasClass('sticky')){
				...
				if(min_header_height_sticky - logo_height >= 10){
					$j('.q_logo a').height(logo_height - 15);
				}else{
					$j('.q_logo a').height(min_header_height_sticky - 20);
				}
            ...
            //  logo part - start //
            if(min_header_height_sticky - logo_height >= 10){
                $j('.q_logo a').height(logo_height - 18);
            }else{
                $j('.q_logo a').height(min_header_height_sticky - 18);
            }
            //  logo part - end //
		}else{
			if($j('header.page_header').hasClass('sticky')){
