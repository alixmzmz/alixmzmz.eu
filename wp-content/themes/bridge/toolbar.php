...
<?php
if (strpos($example_url,'bridge/') || (!strpos($example_url,'bridge2/') && !strpos($example_url,'bridge3/') && !strpos($example_url,'bridge4/') && !strpos($example_url,'bridge5/') && !strpos($example_url,'bridge6/') && !strpos($example_url,'bridge7/') && !strpos($example_url,'bridge8/') && !strpos($example_url,'bridge9/') && !strpos($example_url,'bridge10/') && !strpos($example_url,'bridge11/') && !strpos($example_url,'bridge12/') && !strpos($example_url,'bridge13/') && !strpos($example_url,'bridge14/') && !strpos($example_url,'bridge15/'))){
?>
