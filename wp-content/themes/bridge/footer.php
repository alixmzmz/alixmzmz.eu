...
if(isset($qode_options_proya['uncovering_footer'])){if ($qode_options_proya['uncovering_footer'] == "yes") $uncovering_footer = true;}
?>
	<footer <?php if($uncovering_footer){echo 'class="uncover"';} ?>>
		...
		<div class="footer_top_holder clearfix">
			<div class="footer_top<?php if(!$footer_in_grid) {echo " footer_top_full";} ?> clearfix">
