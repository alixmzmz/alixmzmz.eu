...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"value" => "",
				"description" => "",
				"dependency" => array('element' => "type", 'value' => array('standard','standard_no_space'))
			),
			array(
				"type" => "dropdown",
				"holder" => "div",
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"value" => "",
                "description" => __("Enter just number, ommit px"),
			...
			array(
				...
				"value" => "",
				"description" => __("Enter just number, ommit px. Applied only for circle or square icon type"),
				"dependency" => array('element' => 'use_custom_icon_size', 'value' => array('yes'))
			),
            array(
                "type" => "textfield",
                ...
                "value" => "",
                "description" => __("Spacing between icon and text. Enter just number, ommit px"),
                "dependency" => array('element' => "use_custom_icon_size", 'value' => array('yes'))
            ),
			array(
				"type" => "colorpicker",
