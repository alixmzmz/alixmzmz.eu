...
<?php
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="post_content_holder">
				<?php if ( has_post_thumbnail() ) { ?>
					<div class="post_image">
						<a href="<?php echo get_post_meta(get_the_ID(), "title_link", true); ?>" title="<?php the_title_attribute(); ?>" target="_blank">
							<?php the_post_thumbnail('full'); ?>
						</a>
					</div>
				<?php } ?>
				<div class="post_text">
					<div class="post_text_inner">
						...
						<?php the_content(); ?>
						<div class="post_more">
							<a href="<?php echo get_post_meta(get_the_ID(), "title_link", true); ?>" class="qbutton" target="_blank"><?php _e('Visit','qode'); ?></a>
						</div>
					</div>
				</div>
			</div>
