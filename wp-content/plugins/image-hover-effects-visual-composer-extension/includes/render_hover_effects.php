...
<div class="ih-item <?php if(($caption_style=='square' && $hover_effect=='effect8')|| ($caption_style=='circle' && $hover_effect=='effect6') ){ echo 'scale_up';} ?> <?php echo $caption_style; ?> <?php echo $hover_effect; ?> <?php echo $caption_direction; ?>" >
	<a <?php echo ( $caption_lightbox == 'yes') ? 'data-fancybox' : '' ; ?> data-type="iframe" class="taphover" data-src="<?php echo $caption_url; ?>" href="<?php echo ( $caption_lightbox == 'yes') ? 'javascript:;' : $caption_url ;  ?>" target="<?php echo $caption_url_target; ?>"> 
